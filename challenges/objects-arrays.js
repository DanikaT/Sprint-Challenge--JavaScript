...
/* Request 1: Create a new array called universities that contains all the universities in the graduates array.  z
...
let universitiesSorted = function(){
...
//animalNames.push(`${zooAnimals[i]["animal_name"]} ${zooAnimals.scientific_name}`)}
//;
